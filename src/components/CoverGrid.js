          ...
          :
            this.props.songs.songs.map((song, i) => {
              return (
                ...
                <CoverGridItem key={i} title={song.songName} artist={song.authorName} uploader={song.uploader} difficulties={song.difficulties} coverImage={song.coverUrl} songKey={song.key} hash={song.hash || song.hashMd5} file={song.file} downloads={song.downloadCount} upvotes={song.upVotes} downvotes={song.downVotes} plays={song.playedCount} />
...
export default connect(mapStateToProps, { refresh, loadMore, downloadSong, deleteSong, setPlaylistPickerOpen, setNewPlaylistDialogOpen, clearPlaylistDialog, createNewPlaylist, addSongToPlaylist, displayWarning })(CoverGrid)