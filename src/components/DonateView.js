  ...
  render() {
    return (
      <div id="donate-view">
        ...
        <p className="paragraph">I work hard to make BeatDrop the best it can be, but I don't always have the time and money to do so.
        ...
        <h3 className="paragraph">Help keep servers alive and support modders and other community members by donating at the links below:</h3>
