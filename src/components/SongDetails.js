        ...
        <div id="song-details">
          ...
          <div className="details-info">
            ...
            <div className="action-buttons">
              ...
              :
                <span className="action-button download-button" onClick={ () => {this.props.downloadSong(this.props.details.hash)} }><span style={ { width: this.props.queueItems[this.props.queueItems.findIndex(song => song.hash === this.props.details.hashMd5)] === undefined ? '102%' : this.props.queueItems[this.props.queueItems.findIndex(song => song.hash === this.props.details.hashMd5)].progress + 5 } }></span><img src={ downloadIcon } alt='' /><span>{this.props.queueItems[this.props.queueItems.findIndex(song => song.hash === this.props.details.hash)] === undefined ? 'DOWNLOAD' : this.props.queueItems[this.props.queueItems.findIndex(song => song.hash === this.props.details.hash)].progress === 100 ? 'DOWNLOAD' : this.props.queueItems[this.props.queueItems.findIndex(song => song.hash === this.props.details.hash)].progress + '%'}</span></span>
              }
