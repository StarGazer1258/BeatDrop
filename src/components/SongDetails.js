      ...
      return (
        <div id="song-details">
          ...
          <div className="details-info">
            ...
            <div className="details-artist" title={ this.props.details.authorName || this.props.details.songAuthorName || this.props.details._songAuthorName || (this.props.details.metadata ? this.props.details.metadata.songAuthorName : '') }>{ this.props.details.authorName || this.props.details.songAuthorName || this.props.details._songAuthorName || (this.props.details.metadata ? this.props.details.metadata.songAuthorName : '')}</div>
